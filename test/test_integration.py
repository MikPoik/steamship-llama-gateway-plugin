...
@pytest.mark.parametrize("model", ["", "NousResearch/Nous-Hermes-Llama2-13b"])
            ...
            blocks=[
                ...
                Block(
                    ...
                    tags=[
                        ...
                        Tag(kind="name", name="generate_image")
                    ],
        ...
        generate_task = gpt4.generate(
            ...
            options={
                "functions": [{
                    "name": "PixToPixTool",
                    "description":
                    "Modifies an existing image according to a text prompt.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "text": {
                            ...
                            "uuid": {
                                ...
                                "string",
                                "description":
                                "UUID for a Steamship Block. Used to refer to a non-textual input generated by another function. Example: \"c2f6818c-233d-4426-9dc5-f3c28fa33068\""
                            }
                        }
                    }
                }, {
